...
import SQLShowcase from "./SQLShowcase";
...
const BACK_END_URL = process.env.REACT_APP_BACKEND_URL ?? (() => {
  console.warn("REACT_APP_BACKEND_URL not set, using default");
  return "https://db-express.onrender.com";
})();
...
function EntitiesDashboard() {
  ...
  const [showSQLShowcase, setShowSQLShowcase] = useState(false);

  function handleSQLTemplateSelect(template: string) {
    ...
    <div className="p-4 sm:p-8 lg:p-12">
      <div className="mx-auto w-full max-w-8xl overflow-hidden rounded-lg bg-white shadow-lg dark:bg-gray-800">
        ...
        <div className="p-6">
          ...
          <div className="mb-4 flex flex-col items-center justify-between space-y-4 md:flex-row md:space-x-4 md:space-y-0">
            ...
            <div className="flex space-x-4">
              <div className="flex flex-wrap">
                ...
                <button onClick={() => setShowSQLShowcase(!showSQLShowcase)} className="rounded bg-purple-500 px-4 py-2 text-sm font-medium text-white hover:bg-purple-600 mb-2 mr-2">
                  SQL Templates
                </button>
          ...
          <DatabaseStats backendUrl={BACK_END_URL} />
          ...
          <div className="overflow-x-auto space-y-2">
            ...
            {showSQLShowcase && <SQLShowcase selectedTableName={selectedTableName} onTemplateSelect={handleSQLTemplateSelect} />}
